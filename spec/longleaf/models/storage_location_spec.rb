...
describe Longleaf::StorageLocation do
  ...
  describe '.check_available' do
    context 'with non-existent path' do
      ...
      it { expect { location.check_available }.to raise_error(Longleaf::StorageLocationUnavailableError, /Path does not exist/) }
    end
    ...
    context 'with non-directory path' do
      ...
      it { expect { location.check_available }.to raise_error(Longleaf::StorageLocationUnavailableError,\
