...
describe Longleaf::SelectionOptionsParser do
    ...
    context 'with file option' do
      ...
      context 'with checksums' do
        ...
        it 'exits on invalid checksum format' do
          ...
          expect { SelectionOptionsParser.parse_registration_selection_options(options, app_config_manager) }.to raise_error(Longleaf::SelectionError)
        end
  ...
  describe '.parse_manifest' do
    context 'with invalid manifest entries' do
      ...
      it 'exits on invalid entry with too few parts' do
        ...
        expect { SelectionOptionsParser.parse_manifest([manifest_file.path]) }.to raise_error(Longleaf::SelectionError)
      end
    ...
    context 'reading from STDIN' do
      it 'exits when multiple STDIN manifests are specified' do
        expect { SelectionOptionsParser.parse_manifest(['@-', 'md5:@-']) }.to raise_error(Longleaf::SelectionError)
      end
    end
  end
  ...
  describe '.create_registered_selector' do
    ...
    context 'validation of mutually exclusive options' do
      it 'exits when both file and location are provided' do
        ...
        expect { SelectionOptionsParser.create_registered_selector(options, app_config_manager) }.to raise_error(Longleaf::SelectionError)
      end
  ...
  describe '.read_from_list' do
    ...
    it 'exits when file does not exist' do
      expect { SelectionOptionsParser.read_from_list('/nonexistent/file.txt') }.to raise_error(Longleaf::SelectionError)
    end
    ...
    it 'exits when list is empty' do
      ...
      expect { SelectionOptionsParser.read_from_list(empty_file.path) }.to raise_error(Longleaf::SelectionError)
    ...
    it 'exits when from_list parameter is empty string' do
      expect { SelectionOptionsParser.read_from_list('  ') }.to raise_error(Longleaf::SelectionError)
    end
  end
